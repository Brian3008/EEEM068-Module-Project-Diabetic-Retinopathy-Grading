...
## Experiment Changes
- Replacing Weighted Random Sampler with the hybrid Sampler to observe any betterment
- Adding Random Affine for transformation and reducing color jitter parameters
